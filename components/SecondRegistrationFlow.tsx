...
const SecondRegistrationFlow: React.FC<SecondRegistrationFlowProps> = ({ theme, language, onBack }) => {
        ...
        {step === 1 ? (
          ...
          >
            <div className="mb-10 text-right">
              <h2 className={`text-2xl md:text-3xl font-black ${titleColor} mb-2`}>  (تجديد الشهادة )</h2>
            ...
            <div className="overflow-x-auto pb-10 flex justify-center w-full">
               <div className={`${theme === 'dark' ? 'bg-slate-900' : 'bg-slate-500'} p-2 md:p-6 min-w-[850px] shadow-inner rounded-xl flex justify-center`}>
                  <div className="bg-white">
                    <SecondRegistrationForm data={formData} date={todayDate} />
                  </div>
               </div>
            </div>
          </motion.div>
