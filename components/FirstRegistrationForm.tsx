...
interface FirstRegistrationFormProps {
    ...
    <div dir="rtl" className="A4-page transition-all mx-auto" style={pageStyles}>
      ...
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="text-center flex-grow pt-2">
          <h1 className="text-[16px] font-bold mb-1 tracking-tight">استمارة تسجيل للحصول على شهادة أساسيات التحول الرقمي</h1>
      ...
      {/* Section 2 */}
      <section className="mb-5">
        <h3 className="font-bold border-b border-black inline-block mb-1 pr-1 text-[11px]">ثانيا: شروط التسجيل والالتحاق بالدورة</h3>
        <ul className="list-none space-y-1" style={{ fontSize: '9px' }}>
          <li>• يتم التسجيل إلكترونيا ويتم استكمال المستندات الورقية من خلال مركز المعلومات بجامعة الفيوم.</li>
      ...
      {/* Section 3 */}
      <section className="mb-5">
        <h3 className="font-bold border-b border-black inline-block mb-1 pr-1 text-[11px]">ثالثا: البيانات الشخصية للمتقدم (تسجيل لأول مرة)</h3>
      ...
      {/* Section 4 */}
      <section className="mb-5">
        <h3 className="font-bold border-b border-black inline-block mb-1 pr-1 text-[11px]">رابعا: اختيار المقررات الدراسية (ضع دائرة حول المقرر الاختياري المطلوب)</h3>
        <div className="grid grid-cols-1 gap-1" style={{ fontSize: '10px' }}>
          <div className="flex gap-4">
            <span className="font-bold shrink-0">(أ) مقررات اجبارية:</span>
            <div className="flex flex-wrap gap-x-8 font-bold">
              <span>١- أساسيات تكنولوجيا المعلومات ونظم التشغيل  IT</span>
              <span>٢- معالج النصوص Word</span>
              <span>٣- العروض التقديمية PowerPoint</span>
              <span>٤- الجداول الالكترونية Exel</span>
              <span>٥- الأمن السيبراني Cyber Security</span>
            </div>
          </div>
          
          <div className="mt-2 pt-2 border-t border-black/10">
            <span className="font-bold block mb-1">(ب)- المقررات الاختيارية من فضلك ضع دائرة على عدد ٢ مقرر من الآتي:</span>
            <div className="flex justify-between items-center px-10 py-2">
              {optionalCourses.map((course, index) => (
                <div key={index} className="relative flex items-center justify-center">
                  <span className="font-bold z-10">{course}</span>
                  {data.optionalCourses.includes(course) && (
                    <div className="absolute w-[calc(100%+24px)] h-[calc(100%+10px)] border-2 border-black rounded-[50%] pointer-events-none"></div>
                  )}
                </div>
              ))}
            </div>
      ...
      <section className="pt-3 border-t-2 border-black mt-2">
        <h3 className="text-center font-bold text-[12px] mb-2">إقرار</h3>
